...
ggplot(fires) +
  geom_point(aes(day_of_year, reorder(Counties, AcresBurned, sum, na.rm = TRUE), size = AcresBurned))
```
...
ui <- fluidPage(
  ...
  sliderInput("quantile", "Quantile", 0, 1, c(0, 1), sep = ""),
  fluidRow(
